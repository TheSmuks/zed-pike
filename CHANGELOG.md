...
### Fixed
- Windows-host/Linux-SSH-remote fallback now selects the Linux `pike-lsp`
  release asset and Unix executable path instead of trying to use a
  Windows `.zip`/`.exe` in the remote worktree.
