...
### Requirement: Auto-installation of a Pike language server
**Reason**: A reliable, editor-agnostic Pike language server is not part
of this milestone.
**Migration**: A future OpenSpec change SHALL add LSP support as a
separate, verified integration and SHALL NOT depend on prior Pike LSP
attempts.
